...
vector<vector<int>> getDirectedGraph(const int n, const vector<vector<int>> &graph) {
...
bool solution(int n, vector<vector<int>> path, vector<vector<int>> order) {
    ...
    auto directedGraph = getDirectedGraph(n, graph);
    auto result = canExplore(n, directedGraph, order);
